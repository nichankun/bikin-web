...
// 1. Ekstraksi Interface agar kode lebih rapi dan konsisten dengan komponen lain
...
export function WorkflowStep({
  ...
  return (
    <div
      // 2. Menggunakan fungsi cn() untuk penggabungan class Tailwind yang kondisional
      className={cn(
        "relative flex items-center justify-between md:justify-normal group",
        isReversed && "md:odd:flex-row-reverse",
      )}
    >
