import { Check, Gift } from "lucide-react"; // Menggunakan Lucide sesuai standar 2026
    ...
    <ScrollAnimation direction={direction}>
      <div
        className={cn(
          ...
          "flex flex-col h-full", // Menjaga tinggi kartu tetap sama
        )}
      >
        <div className="relative z-10">
          ...
          <a
            href="#wa"
            className="w-full block text-center py-4 rounded-xl font-bold transition-all duration-300 bg-slate-900 text-white hover:bg-brand-600 hover:shadow-lg hover:shadow-brand-500/20"
          >
            {btnText}
          </a>
        </div>
